...
SELIC_META = 432T      # Taxa de juros - Meta Selic definida pelo Copom
...
BOOVESPA_VALOR_LISTADAS = 7849	# Valor das empresas listadas na Bovespa
DOWN_JONES = 7809               # Dow Jones NYSE - índice
NASDAQ = 7810                   # Nasdaq - índice

PIB_RS_CORRENTE = 1207  # Produto interno bruto em R$ correntes
PIB_VAR_% = 7326        # Produto Interno Bruto - Taxa de variação real no ano
